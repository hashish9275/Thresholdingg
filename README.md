...
plt.show()
```
![image](https://github.com/user-attachments/assets/cbee63cf-7e1d-4f9a-bf8c-403766ee2696)
...
plt.show()
```
![image](https://github.com/user-attachments/assets/0826262c-cc68-4af5-90ca-4d7492845c9e)
...
plt.show()
```
![image](https://github.com/user-attachments/assets/774c7740-9f57-4cac-9df5-893beb9488d4)
...
plt.show()
```
![image](https://github.com/user-attachments/assets/78bd0216-d18c-4d9d-85e6-661a3abe279f)
